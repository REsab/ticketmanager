    ...
    <div class="layui-row">
        <form class="layui-form" action="Admin" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="password" id="L_userPass" name="userPass" required="" lay-verify="userPass"
                           autocomplete="off" class="layui-input"></div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_role" name="role" required="" lay-verify="role" autocomplete="off"
