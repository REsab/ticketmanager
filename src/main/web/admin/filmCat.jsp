                ...
                <div class="layui-card-body ">
                    <div class=" layui-col-space5">
                        ...
                        <div class="layui-inline layui-show-xs-block layui-col-md-offset4">
                            <input type="text" id="searchBox" name="sreachfilmName1" placeholder="请输入要搜索的分类"
...
<script>
    layui.use('table', function () {
        ...
        table.render({
            elem: '#Film'
            , url: 'filmcat?oper=list2'
            , height: 'full-300'
            , cellMinWidth: 66 //全局定义常规单元格的最小宽度，layui 2.2.1 新增
            , cols: [[
                {type: 'checkbox', fixed: 'left'}
                , {field: 'catId', width: 80, title: 'ID', sort: true}
                , {field: 'catName', width: 80, title: '分类', sort: true}
                , {field: 'createBy', width: 80, title: '创建者'}
                , {field: 'updateBy', title: '最新更新', minWidth: 80} //minWidth：局部定义当前单元格的最小宽度，layui 2.2.1 新增
...
<script>
    function search() {
        ...
        layui.use('table', function () {
            ...
            table.render({
                elem: '#Film'
                , url: 'filmcat?oper=search&filmcat=' + $("#searchBox").val()
                , method: "get"
                ...
                , cols: [[
                    ...
                    , {field: 'catName', width: 80, title: '分类', sort: true}
                    , {field: 'createBy', width: 80, title: '创建者'}
                    , {field: 'updateBy', title: '最新更新', minWidth: 10} //minWidth：局部定义当前单元格的最小宽度，layui 2.2.1 新增
                ]]
                , page: true
                , id: 'FilmReload'
            });
    ...
    layui.use('table', function () {
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                xadmin.open("编辑", '/static/back/filmInfo-edit.jsp', '', '', false)
    ...
    function delAll() {
        ...
        layui.use('table', function () {
            ...
            for (var i = 0; i < checkStatus.data.length; i++) {
                codeId += checkStatus.data[i].catId + ",";
                codefilmName += checkStatus.data[i].catName + ",";
            }
