...
public class CinemaBean {
    ...
    public CinemaBean(String CinemaName, String AccoutName, String AccoutPwd, String Tel2, String Tel1, String Addr3County, String Addr2City, String Addr1Province, Date OpenTimeEnd, Date OpenTimeStart) {
        super();
        this.ID = ID;
        this.CinemaName = CinemaName;
        this.AccoutName = AccoutName;
    ...
    public CinemaBean(String CinemaName, String AccoutName, String AccoutPwd, String Tel2, String Tel1, String Addr3County, String Addr2City, String Addr1Province) {
        super();
        this.ID = ID;
        this.CinemaName = CinemaName;
        this.AccoutName = AccoutName;
